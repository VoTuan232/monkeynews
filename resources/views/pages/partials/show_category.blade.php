                ...
                @foreach($value as $post)
                    <div class="item px-2">
                        <div class="fh5co_hover_news_img">
                            ...
                            <div>
                                <a href="{{ route('home.single', ['slug' => str_slug($post->slug)]) }}" class="d-block fh5co_small_post_heading"><span class="">{!! substr(strip_tags($post->title), 0, 20) !!}{{ strlen(strip_tags($post->title))>20 ? "..." : ""}}</span></a>
