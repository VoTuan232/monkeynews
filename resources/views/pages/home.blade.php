...
<div class="container-fluid paddding mb-5">
    <div class="row mx-0">
        <div class="col-md-6 col-12 paddding animate-box" data-animate-effect="fadeIn">
            <div class="fh5co_suceefh5co_height"><img src="{{ asset(Config::get('social.image_post').'/'.$new->image) }}" alt="img"/>
        ...
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="{{ asset(Config::get('social.image_post').'/'.$list->image) }}" alt="img"/>
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
        ...
        <div class="owl-carousel owl-theme js" id="slider1">
            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    <div class="fh5co_latest_trading_img"><img src="{{ asset(Config::get('social.image_post').'/'.$list->image) }}" alt=""
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="{{ asset(Config::get('social.image_post').'/'.$post->image) }}" alt="img"/></div>
                            <div></div>
                        </div>
                    </div>
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img src="{{ asset(Config::get('social.image_post').'/'.$post->image) }}" alt="img" class="fh5co_most_trading"/>
                    </div>
